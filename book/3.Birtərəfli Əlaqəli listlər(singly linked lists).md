...
Əlaqəli listi zəif salan, bir neçə cəhətləri var. Ən böyük çatışmazlığı, müəyyən bir elementə çatmaq üçün istifadə etdiyi vaxtdır. Əgər xatırlasaq, demişdik ki, massiv üçün bu vaxt O(1)-dir. Lakin, əlaqəli listdə, elementə çatmaq ən pis halda O(n)-dir. Massivin digər üstünlüyü, onun elementlərinin ərazi(yaddaş) yaxınlığıdır. Belə ki, massivin elementləri yuxarıdakı missallarda da göstərildiyi kimi, ardıcıl ayrılmış yaddaş adreslərində yerləşirlər. Dolayisi ilə, onlar fiziki olaraq bir-birinə yaxındırlar və bu müasir CPU keşləmə(caching) metodlarından səmərəli istifadə etməyə imkan verir.
