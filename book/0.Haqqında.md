...
Bu dilə vaxt və sərmayə ayırmaq məsləhətdir və günümüzün yeni peşələrinə daha tez uyğunlaşmanıza yardımçı olacaq.

# Müəllif haqqında
Kitabı Github-da Azerbaijan Python User Group-un adı altında yazmağıma səbəb budur ki, bu kitab, Open Source, hər tənqidə açıq, havayı və yayıla bilən olmalıdır. Dolayısı ilə, ilkin məqsəd, kitaba Azərbaycandan hər kəsin əlavə və dəyişikliklər göndərməsi yönündədir.
