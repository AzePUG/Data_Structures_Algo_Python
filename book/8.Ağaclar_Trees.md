...
Əgər hər bir node-un yalniz 2 ardıcılı və ya 0 ardıcılı varsa, bu zaman belə ağaca dəqiq ikili ağac deyilir.
...
* Tam ikili ağacda isə node-ların sayı `n`, minimum ![](http://mathurl.com/yaxexmdc.png)-a, maksimum ![](http://mathurl.com/y8k7mgq4.png)-ə bərabərdir.
...
Digər tərəfdən, ağacı qət etmək onun bütün node-larını ziyarət etmək deməkdirsə, ağacda axtarış lazımlı(axtarılan) node tapılanda dayanır.
...
Bu o deməkdir ki, əgər biz hal-hazırkı node(`D`)-a əsasən təsnifat aparırıqsa və bu node ortada gəlirsə, bu zaman bizim üçün elə də fərq etmir ki, `L` `D`-dən solda ya `R` `D`-dən sağda yerləşir.
...
Yuxarıdakı şəklimizə baxsaq, bu qət etmə zamanı ilk öncə `1` daha sonra sol altağac daha sonra da sağ altağac emal olunacaq.
...
Yuxarıdakı şəklimizə baxsaq bu zaman deyə bilərik ki, bizdə 8 ən sonda görsənəcək və hər bir altağacın özünün root node-u da ən sonda ziyarət olunmalıdır. Dolayısı ilə, nəticəmiz `1 4 7 6 3 13 14 10 8` şəklində olmalıdır.
...
Bu məqsədlə biz Python-da olan queue modulundan istifadə edərək, ziyarət etdiyimiz node-ları növbəyə düzəcəyik(FİFO).
...
Hörmətli oxucu, bununla da bizim Ağac və xüsusən də ikili ağaclar haqqında söhbətimizə burda fasilə veririk.
